...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .stat-done .stat-value { color: #ef4444; }
  .stat-blocked .stat-value { color: #ef4444; }
  table { width: 100%; border-collapse: collapse; margin-bottom: 2rem; }
  th { text-align: left; padding: 0.75rem; border-bottom: 2px solid #262626; color: #ef4444; font-size: 0.85rem; text-transform: uppercase; }
  td { padding: 0.75rem; border-bottom: 1px solid #1a1a1a; }
  tr:hover { background: #171717; }
  .status-active { color: #22c55e; font-weight: 600; }
  .status-done { color: #ef4444; }
