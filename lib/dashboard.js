...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  th { text-align: left; padding: 0.75rem; border-bottom: 2px solid #262626; color: #ec4899; font-size: 0.85rem; text-transform: uppercase; }
...
<footer>@grainulation/orchard</footer>
</body>
</html>`;
}
